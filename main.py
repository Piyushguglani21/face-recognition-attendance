...
person1_image = face_recognition.loadimage_file("faces/person1.jpeg")
person1_encoding = face_recognition.face_encodings(person1_image)[0]

person2_image = face_recognition.loadimage_file("faces/person2.jpeg")
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        #Add the text if a person in present
